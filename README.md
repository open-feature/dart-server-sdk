...
<p align="center" class="github-badges">
  ...
  <a href="https://github.com/open-feature/dart-server-sdk/releases/tag/v0.0.14">
    <img alt="Release" src="https://img.shields.io/static/v1?label=release&message=v0.0.14&color=blue&style=for-the-badge" />
  </a>
...
```yaml
dependencies:
  openfeature_dart_server_sdk: ^0.0.14
```
<!-- x-release-please-end -->
